//data in memory
const catBreeds = { //object catBreeds with two key-value pair
...
const breedDetails = function(breed) {
  //can simply return it(easy peezee, butter squeeezy)...
  return catBreeds[breed]; //returning value of key 'Bombay' of object 'catBreeds'
}
